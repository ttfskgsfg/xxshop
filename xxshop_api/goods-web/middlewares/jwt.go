...
import (
	...
	"net/http"
	"time"
	"xxshop-api/goods-web/global" //global里要设置加密密钥
	"xxshop-api/goods-web/models"
)
...
func JWTAuth() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.Set("claims", claims)    //claim为之前model中定义的customclais结构体
		c.Set("userId", claims.ID) //set一个值到context中
