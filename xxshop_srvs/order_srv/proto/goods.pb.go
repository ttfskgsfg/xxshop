...
type GoodsFilterRequest struct {
	...
	Brand       int32  `protobuf:"varint,10,opt,name=brand,proto3" json:"brand,omitempty"` //通过品牌查询商品
}
...
type GoodsInfoResponse struct {
	...
	Brand           *BrandInfoResponse         `protobuf:"bytes,22,opt,name=brand,proto3" json:"brand,omitempty"`       //商品所属品牌信息
}
...
var file_goods_proto_depIdxs = []int32{
	...
	9,  // 6: CategoryBrandResponse.brand:type_name -> BrandInfoResponse
	...
	9,  // 10: GoodsInfoResponse.brand:type_name -> BrandInfoResponse
