...
type CartItemRequest struct {
	...
	GoodsName  string  `protobuf:"bytes,4,opt,name=goodsName,proto3" json:"goodsName,omitempty"` //把商品信息添加进来  让用户支付的时候能显示最新价格
...
type OrderInfoResponse struct {
	...
	Id      int32   `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	UserId  int32   `protobuf:"varint,2,opt,name=userId,proto3" json:"userId,omitempty"`
	OrderSn string  `protobuf:"bytes,3,opt,name=orderSn,proto3" json:"orderSn,omitempty"` //订单编号 只有提交的时候后台才能看到
...
type OrderInfoDetailResponse struct {
	...
	OrderInfo *OrderInfoResponse   `protobuf:"bytes,1,opt,name=orderInfo,proto3" json:"orderInfo,omitempty"` //要知道订单详细信息
...
var file_order_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x8b,
...
var file_order_proto_depIdxs = []int32{
	...
	3,  // 7: Order.CreateOrder:input_type -> OrderRequest
	8,  // 8: Order.OrderList:input_type -> OrderFilterRequest
	3,  // 9: Order.OrderDetail:input_type -> OrderRequest
	1,  // 10: Order.UpdateOrderStatus:input_type -> OrderStatus
	10, // 11: Order.CartItemList:output_type -> CartItemListResponse
	5,  // 12: Order.CreateCartItem:output_type -> ShopCartInfoResponse
	11, // 13: Order.UpdateCartItem:output_type -> google.protobuf.Empty
	4,  // 14: Order.CreateOrder:output_type -> OrderInfoResponse
	9,  // 15: Order.OrderList:output_type -> OrderListResponse
	7,  // 16: Order.OrderDetail:output_type -> OrderInfoDetailResponse
